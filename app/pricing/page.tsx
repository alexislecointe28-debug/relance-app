...
const PLANS = [
  ...
  },
  {
    ...
    features: ['300 dossiers', 'Emails de relance illimités', 'Dashboard équipe', 'Support prioritaire'],
    cta: 'Choisir Solo',
    highlight: true,
  },
  {
    ...
    features: ['Dossiers illimités', 'Multi-clients', 'Export PDF', 'Support dédié'],
    cta: 'Choisir Agence',
    highlight: false,
  },
]
